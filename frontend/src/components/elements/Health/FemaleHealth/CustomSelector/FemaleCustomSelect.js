...
import './FemaleCustomSelect.css';
import '../../../../../components/elements/Profile/custom-profile-data-select/CustomSelect';
...
.select-input::placeholder {
  ...
  return (
    ...
    <div className={`custom-select ${className} ${isOpen ? 'expanded' : ''} ${hasValue(value) ? 'has-value' : ''}`} ref={selectRef} id={id}>
      <div className="femail-select-header" onClick={toggleDropdown}>
        <input
          type="text"
