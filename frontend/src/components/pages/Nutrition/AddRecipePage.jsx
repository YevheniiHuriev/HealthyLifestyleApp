...
const AddRecipePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name.trim() || !formData.description.trim() || !formData.time.trim()) {
      showMessage("Будь ласка, заповніть обов'язкові поля (позначені *)", "error");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      if (validIngredients.length === 0) {
        showMessage("Додайте хоча б один інгредієнт", "error");
        setLoading(false);
        return;
      }
      ...
      if (validSteps.length === 0) {
        showMessage("Додайте хоча б один крок приготування", "error");
        setLoading(false);
        return;
      }
      ...
      showMessage("✅ Рецепт успішно додано!", "success");
      ...
      const errorMessage = error.response?.data?.message || "Помилка при додаванні рецепта";
        ...
        <div className="recipe-page-grid-v2">
            ...
            <form onSubmit={handleSubmit}>
              <div className="main-image-card glass-card">
                <div className="image-upload-section">
                  <h2 className="card-title-white">Зображення рецепта</h2>                
                  <div 
                    ...
                    {imageFile ? (
                      <div className="image-preview">
                        ...
                        <div className="image-overlay">
                          <span className="change-image-text">Змінити зображення</span>
                        </div>
                      </div>
                    ) : (
                      <div className="upload-placeholder-content">
                        ...
                        <p className="upload-text">Натисніть для завантаження зображення</p>
                        <p className="upload-subtext">PNG, JPG, WEBP до 5MB</p>
                      </div>
                    )}
                  </div>
              ...
              <div className="recipe-steps-card glass-card">
                <h2 className="card-title-white">Кроки приготування *</h2>
                <div className="steps-list">
                  {formData.steps.map((step, index) => (
                    <div key={index} className="step-input-group">
                      <label>Крок {index + 1}</label>
                      <textarea
                        value={step}
          ...
          <div className="details-sidebar-column">
            <div className="header-details-card">
              <h1 className="recipe-title-v2">Додати новий рецепт</h1>         
            ...
            <div className="ingredients-card glass-card">
              <h2 className="card-title-white">Інгредієнти *</h2>
